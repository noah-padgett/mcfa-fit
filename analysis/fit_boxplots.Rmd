...
p <- ggplot(mydata, aes(x=Model, y=CFI))+
    ...
    geom_abline(intercept = .95, slope=0,
                linetype='dashed', color = 'red')
p
if(save.fig == T) ggsave("pub_fig_cfi.pdf",plot = p, width=6, height=4, units='in')
...
p <- ggplot(mydata, aes(x=Model, y=RMSEA))+
    ...
    geom_abline(intercept = .06, slope=0,
                linetype='dashed', color = 'red')
p
if(save.fig == T) ggsave("pub_fig_rmsea.pdf",plot = p, width=6, height=4, units='in')
...
p <- ggplot(mydata, aes(x=Model, y=SRMRW))+
    ...
    geom_abline(intercept = .08, slope=0,
                linetype='dashed', color = 'red')
p
if(save.fig == T) ggsave("pub_fig_srmrw.pdf", plot = p, width=6, height=4, units='in')
...
p <- ggplot(mydata, aes(x=Model, y=SRMRB))+
    ...
    lims(y=c(0,1))
p
if(save.fig == T) ggsave("pub_fig_srmrb_a.pdf",plot = p, width=6, height=4, units='in')
...
p <- ggplot(mydata, aes(x=Model,  y=SRMRB))+
    ...
    lims(y=c(0,1))
p
if(save.fig == T) ggsave("pub_fig_srmrb_b.pdf",plot = p, width=6, height=4, units='in')
